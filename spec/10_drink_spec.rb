...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_drink) { described_class.new('sparkling water', 16) }
      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_drink.type).to eq('sparkling water')
      end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      # Create an explicit subject, using 'described_class' and your choice of
      # beverage type.
      subject(:my_lemonade) { described_class.new('lemonade', 16)}
      # remove the 'x' before running this test
      it 'is full' do
        expect(my_lemonade).to be_full
      end
    end
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_tea) { described_class.new('tea', 12) }
      # remove the 'x' before running this test
      it 'is not full' do
